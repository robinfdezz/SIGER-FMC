  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-800 shadow-xs">
        ...
        <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-neutral-700 dark:text-neutral-300 bg-gray-100 dark:bg-neutral-800 px-3.5 py-1.5 rounded-xl border border-gray-200/80 dark:border-neutral-700/80 shadow-xs self-start sm:self-center">
          <span className="font-bold text-neutral-900 dark:text-neutral-100">{branches.length}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {branches.map((branch) => {
          ...
          return (
            <div
              key={branch.id}
              className={`relative flex flex-col justify-between p-5 sm:p-6 rounded-2xl bg-white dark:bg-neutral-900 border transition-all ${isUserOwnBranch
              ...
              <div className="mt-5 pt-4 border-t border-neutral-100 dark:border-neutral-800/80 flex items-center justify-between">
                ...
                {canEditThisBranch ? (
                  ...
                  <Button
                    ...
                    disabled
                    icon={Lock}
                    className="opacity-60 border-dashed cursor-default select-none pointer-events-none"
                  >
                    Solo Lectura
                  </Button>
                )}
